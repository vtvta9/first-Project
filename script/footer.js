    ...
    <div class="footer__container">
            ...
            <div class="row">
                ...
                <div class="footer__container__about">
                    ...
                    <a href="#">
                        <img src="../assets/img/logo.webp" alt="" /> Travelix
                    </a>
                    </div>
                ...
                <div class="footer__container__blog">
                    ...
                    <div class="container__blog__item">
                        ...
                        <img
                            src="../assets/img/xfooter_blog_1.jpg.pagespeed.ic.n5JT1wzbm-.webp"
                            alt=""
                        />
                    ...
                    <div class="container__blog__item">
                        <div class="container__blog__item--img">
                        <img
                            src="../assets/img/xfooter_blog_2.jpg.pagespeed.ic.u_Bp7zMu38.webp"
                            alt=""
                        />
                        <div class="container__blog__item--text">
                    ...
                    <div class="container__blog__item">
                        <div class="container__blog__item--img">
                        <img
                            src="../assets/img/xfooter_blog_3.jpg.pagespeed.ic.XDkX_CloU3.webp"
                            alt=""
                        />
                        <div class="container__blog__item--text">
                            <a href="#">Travel with us this year</a><br />
                ...
                <div class="footer__container__contact">
                    ...
                    <div class="container__contact__info">
                        ...
                        <span>82 Nguyen Luong Bang, Lien Chieu</span>
                    </div>
                    <div class="container__contact__info">
                        <div class="container__contact__info--img">
                        </div>
                        <span>+84 353528071</span>
                    </div>
                    <div class="container__contact__info">
                        <div class="container__contact__info--img">
                        </div>
                        <span>vtvt1la9@gmail.com</span>
                    </div>
                    <div class="container__contact__info">
                        <div class="container__contact__info--img">
                        </div>
            ...
            <span class="copyright"
                >Copyright © 2021 By<a
                href="https://www.facebook.com/profile.php?id=100010177215568"
                >
                TRAN VAN THIN</a
                ></span
            >
